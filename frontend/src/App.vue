    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-groups">
        <section v-for="group in navGroups" :key="group.label" class="sidebar-group">
          <header class="side-section-label">
      ...
      <button class="version version-button" title="检查软件更新" @click="updater.check(true)">EvoAgent V{{ updater.installedVersion }} <RefreshCw :size="10"/></button>
    </aside>
